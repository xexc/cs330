...
private:
	...
	ShapeMeshes* m_cupMesh;
	ShapeMeshes* m_pencilMesh;
	glm::vec3 m_cupPosition;
	glm::vec3 m_pencilPositions[3]; // 3 pencils


	// Add member variables for grey cube
	GLuint m_cubeVAO;
	GLuint m_cubeVBO;
	GLuint m_cubeEBO;

	void CreateGreyCubeMesh();
